    ...
    <div className="min-h-screen bg-[#fcf8f8] flex items-center justify-center py-4 sm:py-8 lg:py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-6 sm:space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-4 sm:mt-6 text-2xl sm:text-3xl font-bold text-[#1b0e0e]">Join StyleHub</h2>
        ...
        <form className="mt-6 sm:mt-8 space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-3 sm:space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div>
                <label htmlFor="first_name" className="block text-xs sm:text-sm font-medium text-[#1b0e0e] mb-2">
                  First Name
                </label>
                <input
                  id="first_name"
                  ...
                  className={`appearance-none relative block w-full px-3 sm:px-4 py-3 sm:py-4 text-base border ${validationErrors.first_name ? 'border-red-500' : 'border-[#f3e7e8]'} placeholder-[#994d51] text-[#1b0e0e] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ea2a33] focus:border-transparent focus:z-10 bg-white`}
                  placeholder="First name"
                />
                {validationErrors.first_name && <p className="mt-2 text-xs sm:text-sm text-red-500">{validationErrors.first_name}</p>}
              </div>

              <div>
                <label htmlFor="last_name" className="block text-xs sm:text-sm font-medium text-[#1b0e0e] mb-2">
                  Last Name
                </label>
                <input
                  id="last_name"
                  ...
                  onChange={handleChange}
                  className={`appearance-none relative block w-full px-3 sm:px-4 py-3 sm:py-4 text-base border ${validationErrors.last_name ? 'border-red-500' : 'border-[#f3e7e8]'} placeholder-[#994d51] text-[#1b0e0e] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ea2a33] focus:border-transparent focus:z-10 bg-white`}
                  placeholder="Last name"
                />
                {validationErrors.last_name && <p className="mt-2 text-xs sm:text-sm text-red-500">{validationErrors.last_name}</p>}
              </div>
            </div>
